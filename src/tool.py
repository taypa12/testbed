...
tools_path = path.join(root_dir, "tools")
temp_path = path.join(root_dir, "tmp")
...
class Apktool(object):
    def __init__(self):
        ...
        if "APKTOOL_PATH" in os.environ:
            ...
            self.apktool_path: str = path.join(tools_path, "apktool.jar")
...
class Jarsigner(object):
    def __init__(self):
        ...
        if "JARSIGNER_PATH" in os.environ:
            ...
            self.jarsigner_path: str = path.join(tools_path, "jarsigner.exe")
...
class Zipalign(object):
    def __init__(self):
        ...
        if "ZIPALIGN_PATH" in os.environ:
            ...
            self.zipalign_path: str = path.join(tools_path, "zipalign.exe")
